...
**Important**  
For examples of how to interact with the configuration API, including operations like creating, updating, and deleting Amazon ES domains, see [Using the AWS SDKs to interact with Amazon Elasticsearch Service](es-configuration-samples.md)\.
