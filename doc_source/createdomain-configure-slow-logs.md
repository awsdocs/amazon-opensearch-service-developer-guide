...
+ Error logs
+ [Search slow logs](https://opensearch.org/docs/latest/monitoring-your-cluster/logs/#slow-logs)
+ [Indexing slow logs](https://opensearch.org/docs/latest/monitoring-your-cluster/logs/#slow-logs)
