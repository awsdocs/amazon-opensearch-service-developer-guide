...
**Pricing**  
Before creating a domain of this size, check the [Amazon Elasticsearch Service Pricing](https://aws.amazon.com/elasticsearch-service/pricing/) page to ensure that the associated costs match your expectations\. Examine [UltraWarm for Amazon Elasticsearch Service \(Preview\)](ultrawarm.md) to see if a hot\-warm architecture fits your use case\.
