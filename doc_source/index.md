...
+ [Monitoring Amazon Elasticsearch Service](monitoring-es.md)
   ...
   + [Monitoring Amazon Elasticsearch Service events with Amazon EventBridge](es-monitoring-events.md)
      + [Tutorial: Listening for Amazon Elasticsearch Service EventBridge events](es-listening-events.md)
      + [Tutorial: Sending Amazon SNS alerts for available software updates](es-sns-events.md)
